...
return [
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'NefbEL740FPIlYncrRZkQyOzwDs9KiVo',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'network'=>"https://nile.trongrid.io", // https://api.trongrid.io  //测试网 https://nile.trongrid.io
    'apikey' => "0a3e45d0-d278-4c3e-a604-01c377789829",
    'contract_address'=>"TXLAQ63Xg1NAzckPwKHvzw7CSEmLMEqcdj",  //TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t 测试合约 TXLAQ63Xg1NAzckPwKHvzw7CSEmLMEqcdj
    'rsa_publickey'=>"",
    'rsa_privatekey'=>"",
];
